...
interface WefBirdAnimationProps {
  className?: string;
  size?: number;
}

export default function WefBirdAnimation({ className = '', size = 160 }: WefBirdAnimationProps) {
  return (
    <motion.div
          ...
          <g id="Group_2908" data-name="Group 2908" transform="translate(-229.338 -608.206)">
            ...
            <g id="Group_2906" data-name="Group 2906">
              ...
              <circle
                ...
                cy="1.417"
                r="1.417"
                transform="translate(248.513 625.964)"
              ...
              <path
                id="Path_1278"
                d="M262.682,628.936a24.24,24.24,0,0,0-2.83-1.555s-2.435-4.252-7.087-4.252-8.5,4.252-8.5,4.252,2.073,4.3,8.5,5.669a21.636,21.636,0,0,0,2.868,5.659A10.268,10.268,0,0,0,262.682,628.936Z"
                fill="var(--color-primary-600, #e13a15)"
              />

              {/* Animated Wings Group (Flapping Motion) */}
              <motion.g
                style={{ transformOrigin: '265px 628px' }}
                animate={{
                  rotate: [-18, 15, -18],
              ...
              >
                ...
                <path
                  id="Path_1279"
                  d="M298.119,617.46c-6.827,0-14.173,2.834-14.173,2.834s-6.152,12.264-16.406,12.734a23.5,23.5,0,0,1,5.068,8.526s9.38-5.548,21.259-11.339,14.174-9.921,14.174-9.921S304.947,617.46,298.119,617.46Z"
                  fill="var(--color-primary-400, #f37744)"
                />

                {/* Wing Joint */}
                <path
                  id="Path_1280"
                  d="M259.852,627.381a20.351,20.351,0,0,1,14.173-18.425v15.321L262.686,628.8l0,.138Z"
                  fill="var(--color-primary-300, #f7a67a)"
                />

                {/* Wing Accent Tip */}
                <path
                  id="Path_1282"
                  d="M283.946,620.294l-21.26,8.5v.14l0,0a10.268,10.268,0,0,1-7.049,9.773,25.462,25.462,0,0,0,9.888,8.514c.454.222.872.4,1.275.564,8.583,3.446,5.812-6.233,5.812-6.233a23.5,23.5,0,0,0-5.068-8.526C277.794,632.558,283.946,620.294,283.946,620.294Z"
                  fill="var(--color-primary-500, #ef4c16)"
                />
              </motion.g>

              {/* Tail Feathers (Subtle Counter Motion) */}
              <motion.g
                style={{ transformOrigin: '272px 641px' }}
                animate={{
                  rotate: [-5, 5, -5],
                }}
                transition={{
